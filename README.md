...
<div class="container">
    ...
    <div id="dashboardSection" class="hidden">
        ...
        <div id="tabWallet" class="tab-content hidden">
            ...
            <div class="card">
                ...
                <div class="plan-box">
                    ...
                    <button class="action-btn" onclick="buySubscription(400, 'Half Monthly Plan')">Buy Half Monthly</button>
                </div>
                <div class="plan-box">
                    <p style="margin: 0 0 5px 0;"><strong>Monthly Plan:</strong> 600 Points</p>
                    <button class="action-btn" onclick="buySubscription(600, 'Monthly Plan')">Buy Monthly</button>
                </div>
                <div class="plan-box">
                    <p style="margin: 0 0 5px 0;"><strong>Half Yearly Plan:</strong> 6000 Points</p>
                    <button class="action-btn" onclick="buySubscription(6000, 'Half Yearly Plan')">Buy Half Yearly</button>
                </div>
                <div class="plan-box">
        ...
        <div id="adminPanelSection" class="card hidden" style="border: 2px solid var(--accent); background: #fffde7;">
            ...
            <!-- Time ki jagah Toss Update field -->
...
<script>
    ...
    function checkAdminAccess() {
        ...
        if(!hasActiveSub) {
            alert("Admin Mode kholne ke liye aapka active subscription hona zaroori hai. Kripya Wallet se plan lein!");
            switchTab('wallet');
            return;
        }
    ...
    function adminTransferPoints() {
        let currentPhone = localStorage.getItem('current_user');
        if(currentPhone !== ADMIN_NUMBER) {
            alert("Ye feature sirf main admin (9569981484) ke liye hai!");
            return;
        }
    ...
    function addNewMatch() {
        ...
        if(editId) {
            ...
            matches.push({ id: Date.now(), series, format, t1, t2, venue, tossUpdate, winner: "Upcoming", t1Score: "", t2Score: "" });
    ...
    function renderSchedule() {
        ...
        matches.forEach((m) => {
            ...
            // Blue Color Toss Update Banner
            if(m.tossUpdate) {
                html += `<div class="match-toss-banner">ℹ️ ${m.tossUpdate}</div>`;
            }

            // Red Color Match Winner Banner
